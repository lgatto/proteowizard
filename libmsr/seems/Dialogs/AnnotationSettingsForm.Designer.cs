namespace seems
{
	partial class AnnotationSettingsForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.showDependentValueLabelCheckbox = new System.Windows.Forms.CheckBox();
			this.showIndependentValueLabelCheckbox = new System.Windows.Forms.CheckBox();
			...
			this.aliasAndColorMappingListBox.Name = "annotationListBox";
			...
			this.addAliasAndColorMappingButton.Name = "addAnnotationButton";
			...
			this.removeAliasAndColorMappingButton.Name = "removeAnnotationButton";
			...
			this.editAliasAndColorMappingButton.Name = "editAnnotationButton";
			...
			this.clearAliasAndColorMappingButton.Name = "clearAnnotationsButton";
			...
			this.groupBox2.Controls.Add( this.showDependentValueLabelCheckbox );
			this.groupBox2.Controls.Add( this.showIndependentValueLabelCheckbox );
			...
			// 
			// showDependentValueLabelCheckbox
			// 
			this.showDependentValueLabelCheckbox.Location = new System.Drawing.Point( 11, 53 );
			this.showDependentValueLabelCheckbox.Name = "showDependentValueLabelCheckbox";
			this.showDependentValueLabelCheckbox.Size = new System.Drawing.Size( 231, 24 );
			this.showDependentValueLabelCheckbox.TabIndex = 1;
			this.showDependentValueLabelCheckbox.Text = "Show dependent value label";
			this.showDependentValueLabelCheckbox.UseVisualStyleBackColor = true;
			// 
			// showIndependentValueLabelCheckbox
			// 
			this.showIndependentValueLabelCheckbox.Location = new System.Drawing.Point( 11, 29 );
			this.showIndependentValueLabelCheckbox.Name = "showIndependentValueLabelCheckbox";
			this.showIndependentValueLabelCheckbox.Size = new System.Drawing.Size( 231, 24 );
			this.showIndependentValueLabelCheckbox.TabIndex = 0;
			this.showIndependentValueLabelCheckbox.Text = "Show independent value label";
			this.showIndependentValueLabelCheckbox.UseVisualStyleBackColor = true;
			// 
			// groupBox3
			// 
			...
			this.Name = "AnnotationSettingsForm";
		...
		private System.Windows.Forms.CheckBox showDependentValueLabelCheckbox;
		private System.Windows.Forms.CheckBox showIndependentValueLabelCheckbox;
