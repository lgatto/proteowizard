...
/*
    ...
    - additional work by Joshua Tasman, ISB Seattle
...
Base64::b64_encode(const unsigned char* unencodedInputBuf,
  ...
  curOutputBuffer_ = new unsigned char[numEncodedCharacters];
  ...
  while (remainingUnencodedInputBytes > 0) {
    encode_group( curOutputBuffer_ + actualEncodedLength, unencodedInputBuf, remainingUnencodedInputBytes > 3 ? 3 : remainingUnencodedInputBytes);
...
Base64::b64_decode ( const char *src,
  ...
  */
  ...
  return (decodedBytePtr - curOutputBuffer_);
}
