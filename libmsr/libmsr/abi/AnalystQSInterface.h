...
#include "wiffqslib/analystqstlbs.h"

class AnalystQSInterface : public BaseInstrumentInterface {
private:
	...
	AnalystQS::IFMANChromDataPtr     m_ipFMANChromData;
	AnalystQS::IFMANSpecDataPtr      m_ipFMANSpecData;
	AnalystQS::IFMANWiffFilePtr      m_ipFMANWiffFile;
	AnalystQS::IPeakFinderFactoryPtr m_ipPeakFinderFactory;
	AnalystQS::IPeakFinder2Ptr       m_ipPeakFinder;
	BSTR                             m_paramsString;
	AnalystQS::IFMANSpecDataPtr      m_ipFMANSpecDataToMerge;
